...
def create_json(rawtext):
    ...
    #### -- PRE-PROCESSING #####
    #### The input forecast discussions are, as far as I know, generated by hand and not a computer program.
    #### They will therefore have typos that can derail this script
    #### I will add them as I find them

    #If there's no space between the "Issued at" line and the beginning of the body text
    dollar_split[0] = re.sub(r"Issued at (.+)\n([^\n])", "Issued at \g<1>\n\n\g<2>", dollar_split[0])
    ...
    for section in sections:
        # Pre-process to account for potential typos that can derail this script
        section = section.replace("... Issued at", "...\nIssued at")
